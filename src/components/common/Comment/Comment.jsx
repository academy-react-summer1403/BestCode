...
const Comment = () => {
  return (
    <>
      ...
      <div className=" w-full bg-[#FFFF] dark:bg-gray-300 mb-5 flex flex-wrap relative rounded-2xl shadow-[0_1px_2px_0px_rgba(0,0,0,0.25)]">
        <button
        ...
        <div class=" w-[95%] mt-[70px] mx-auto px-4 bg-[#F9F9F9] rounded-lg shadow-[0_1px_2px_0px_rgba(0,0,0,0.25)] ">
          <article class="p-2 text-base    ">
            <footer class="flex justify-between items-center mb-2 border-b-2 relative">
              <div class="flex flex-wrap items-center w-[202px] h-[62px]  relative ">
                <div className="w-[28%] h-[95%] rounded-full border-2 border-[#E4E4E4] ">
                  <img
                    class=" w-[85%]  m-auto mt-[3.5px] rounded-full"
                    src="https://flowbite.com/docs/images/people/profile-picture-2.jpg"
                    alt="Michael Gough"
                  />
                </div>
                <p class="inline-flex items-center w-[70%] h-[50%] text-[15px] max-smx2:text-[13px] text-[#003B39] relative bottom-3 right-2 ">
                  کاربر | ali@gmail.com
                </p>
                <p class="text-sm text-[#888888]  w-[70%] h-[50%] absolute bottom-[0px] right-[65px]">
                  <time
                    pubdate
                    datetime="2022-02-08"
            ...
            <p class="text-gray-500  max-smx3:text-[11px]">
          ...
          <article class="p-6 mb-3 mx-auto relative bottom-4 shadow-[0_-2px_4px_0px_rgba(0,0,0,0.2)] text-base bg-[#ECECEC] rounded-xl border-r-4 border-[#01CEC9] dark:bg-gray-300
                          
                          max-xl:h-[170px] max-xl:
                         ">
            <footer class="flex justify-between items-center mb-2 border-b-2 border-[#DDDDDD] relative ">
              <div class="flex flex-wrap items-center w-[202px]   relative ">
                <div className="w-[28%] rounded-full border-2 border-[#01CEC9] ">
                  <img
          ...
          <article class="p-2 text-base    ">
            <footer class="flex justify-between items-center mb-2 border-b-2 relative">
              <div class="flex flex-wrap items-center w-[202px] h-[62px]  relative ">
                ...
                className="inline-flex items-center w-[70%] h-[50%] text-[15px] max-smx2:text-[13px] text-[#003B39]  relative bottom-3 right-2 ">
                  کاربر | ali@gmail.com
                </p>
                <p class="text-sm text-[#888888] w-[70%] h-[50%] absolute bottom-[0px] right-[65px]">
                  <time
          ...
          <article class="p-6 mb-3 mx-auto relative bottom-4 shadow-[0_-2px_4px_0px_rgba(0,0,0,0.2)] text-base bg-[#ECECEC] rounded-xl border-r-4 border-[#01CEC9] dark:bg-gray-300
            ...
            <footer class="flex justify-between items-center mb-2 border-b-2 border-[#DDDDDD] relative">
              <div class="flex flex-wrap items-center w-[202px] h-[62px]  relative ">
                ...
                <p className="inline-flex items-center w-[70%] text-[15px] max-smx2:text-[13px] text-[#003B39] relative bottom-3 right-2 ">
                  مهدی اصغری | مدرس
                </p>
                <p class="text-sm text-[#888888] w-[70%]  absolute bottom-[0px] right-[65px]">
                  <time
                    pubdate
                    datetime="2022-02-08"
                    title="February 8th, 2022"
            ...
            <p className="text-gray-500 max-smx3:text-[11px]">
              سلام عزیز. حدودا 9 روز دیگه (1 اردیبهشت) برای این دوره تخفیف
              خواهیم داشت. برای مطلع شدن از تخفیف‌ها و جشنواره‌ها لطفا خود سایت
              و سوشال های سبزلرن رو دنبال کنین 👌❤️{" "}
            </p>
