...
const Group146 = ({item , index}) => {
  return (
    <Fragment>   
                ...
                shadow-[0px_1px_2px_0px_#00000026] mt-[9px] pr-[31px] pl-[28px]
                " >
                    ...
                    <div className='mr-[62px] w-[70px] text-center'>
                        <p className='
                        font-primaryRegular text-[#555555] text-[14px] font-[700]' >{item.sorting}</p>
                    </div>
                    ...
                    <div className="h-[20px] w-[30px]" >
                      <p  className='text-[#555555] text-[14px] font-primaryMedium font-[700]' >{item.number}</p>
                    </div>
                  </div>
    </Fragment>
  )
