...
const LogInFirstStep = ({setActive}) => {
    return(
        <Formik  >
               <div className="flex  sm:ml-0 ab:ml-[12%]   ">
            ...
            <div className="cd:w-[377px] cd:h-[400px] bg-[url(../02.png)] dark:bg-[url(../44.png)] 
  bg-contain bg-no-repeat  cd:mt-[50px] lg:mt-[113px] 
        ...
        <Form>
<h1 className="sm:text-[20px] md:text-[25px] leading-[35.46px] text-[#005351] justify-center   mx-auto cd:mt-[14%] md:mt-[12%] sm:mt-[10%] ab:mt-[8%]
...
<Field  type="text" placeholder="شماره همراه یا ایمیل" className="w-[74%] ab:h-[35px] md:h-[45px] text-right rounded-[9px]  font-BYekan
   bg-[#F7F7F7]  shadow-[0px_1px_2px_0px_#00000040_inset]

md:text-[17px] ab:text-[13px]
 mx-auto ml-[13%] cd:mt-[10%] sm:mt-[5%] ab:mt-[7%] md:mt-[8%]  pr-[22px]"/>
...
bg-[#F7F7F7]  shadow-[0px_1px_2px_0px_#00000040_inset] md:text-[17px] ab:text-[13px]
 md:mt-[3%] ab:mt-[5%] mx-auto ml-[13%] pr-[22px] "/>  
<div className="text-[11px] sm:w-[90%] md:w-full flex mx-auto justify-between md:mt-4 ab:mt-2 xl:ml-[16%] lg:ml-[16%] cd:ml-[15%] md:ml-[13%] ab:ml-[15%]" >
...
ab:ml-[30%] ab:bottom-[-5px]  md:bottom-2  cd:bottom-2 lg:bottom-0 lg:mt-[8%] ab:text-[13px] md:text-[16px]">
دریافت کد تایید</button>
<button className=" mt-[11%] text-[#008E8B] relative ab:top-[33px] md:top-[27px] cd:top-[30px] xl:top-[37px] lg:top-[35px] cd:right-[100px] md:right-[90px] sm:right-[80px] ab:right-[80px]">ثبت نام</button>
    </Form>
</div>
</div>
<button className=" dark:text-[#005351] relative cd:top-[280px] cd:right-[500px] md:top-[210px] md:right-[440px] 
 sm:top-[185px] sm:right-[370px]  ab:top-[197px] ab:right-[280px] lg:top-[320px] lg:right-[580px] xl:top-[320px] xl:right-[580px] text-[#AAAAAA] ab:text-[18px] md:text-[20px] text-nowrap">صفحه اصلی</button>
</div>
