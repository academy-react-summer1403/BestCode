...
const CourseSearch = () => {
  return (
    <Form>
      <div className="w-full m-0 h-[412px]  flex justify-center mt-[77px] ">
        <div
        ...
        >
          ...
          <div className=" w-[80%] grid lg:flex lg:flex-col lg:items-end justify-center lg:justify-start">
              ...
              <p1 className="font-bold text-[35px] text-nowrap text-center sm:text-right lg:mr-[54px]  ">
                دوره های آموزشی
              </p1>
              <p2 className="font-[400] text-[16px] sm:text-[20px] text-nowrap lg:ml-0 cd:ml-[240px] md:ml-[160px] lg:mr-[54px] sm:ml-[80px] text-[#AAAAAA]">
                به روز ترین دوره هایی که میتونید پیدا کنید
              </p2>
              
                <Field
                  placeholder="...چی میخوای یاد بگیری؟"
                  className="md:w-[480px] sm:w-[400px] sm:h-[50px] ab:h-[45px] cd:w-[558px] lg:w-[420px] ef:w-[480px] xl:w-[558px] md:h-[65px] rounded-[35px] ab:pr-[20px] sm:pr-[48px] mt-[27px] lg:mr-[20px]   xl:mr-[55px] bg-[#FAFAFA] border-[1px] border-[#DFDFDF80] backdrop-blur-[5px] 
