...
const Card = () => {
  return (
    <>
    <div className=" w-[92%] h-[496px]  flex flex-wrap relative m-auto
                    ">
          <div className=" w-[100%] h-[112px] bg-[#F7F7F7] flex rounded-[10px] shadow-[0_1px_2px_0px_rgba(0,0,0,0.2)] relative 
                        
                         ">
                
                <div className=" w-[35%] h-[84px]  rounded-[6px] shadow-[0_1px_1px_0px_rgba(0,0,0,0.2)] absolute top-[14px] right-[16px] ">
                <img src={images.fig}/>
