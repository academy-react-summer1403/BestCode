...
const Top = () => {
  return (
    <>
      <div className=" h-[101%] w-[49%] bg-[#FFFF] flex flex-wrap rounded-2xl shadow-[0_1px_2px_0px_rgba(0,0,0,0.25)]" 
      >
        
        <div className=" h-[41px] w-[100%]  flex gap-[30%] max-lg:gap-[5%] mt-[31px] " >
        ...
        <div className=" h-[84px] w-[100%]  ">
             <div className=" h-[100%] w-[93%]  m-auto text-[18px] leading-[27px] font-normal aling-right text-slate-600"> 
        ...
        <div className=" h-[50px] w-[100%]  flex gap-[33%] max-xl:gap-[25%] max-lg:gap-[8%] ">
